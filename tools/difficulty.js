...
const OVERRIDES = {
  ...
  // CEO / Crab / 2x9 (2026-09-11 ユーザー決定). 計測値は色の上限を大きく超えるため上位帯に収める:
  // ceo:300 3169→2800, ceo:500 7036→3200 (作業量 labor=500x151 が支配的), crab:30 3202→3000,
  // packed2x9:18 3846→3200 (空きマスゼロ. LNS2 は 8 seed 全滅, LaCAM3 も下界比 9 倍)
  'ceo:300': 2800, 'ceo:500': 3200, 'crab:30': 3000, 'packed2x9:18': 3200,
  // Contest 001 (2026-09-11): 32x32 の通路がほぼ全面幅 1 で狭路指標 C=11.4/44.6 と較正範囲 (C<=3.4) を大きく外れ,
  // X=cW*C^4 が暴走する (計測 19.6 万 / 4554 万). 他の成分 (g/e/t/labor) は健全で X 抜きなら 1628 / 2409.
  // ユーザー決定 (2026-09-11): Div.2 (30 台) 1600, Div.1 (75 台) 2400.
  // Div.1 は計測せず (32x32 の通路がほぼ全面幅 1 で狭路指標 C が較正範囲外になり式が破綻するため)
  ...
  // 100 (登録ユーザー 100 人突破の記念マップ, 2026-09-21 ユーザー決定): 上位の 2 ステージは計測値
  // (1296 / 2061) より高く始める. 10/20/30 は計測値のまま (303 / 761 / 769)
  'hundred:50': 1600, 'hundred:100': 2400,
};
