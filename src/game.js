...
(function () {
  ...
  const I18N = {
    ja: {
      ...
      'card.agentsLegend': '右端は<b>移動手数 / 最短手数</b>: <b class="lg opt">緑=最短で到達</b> · <b class="lg over">橙=遠回り</b> · <b class="lg">灰=未到達</b>',
    ...
    en: {
      ...
      'card.agentsLegend': 'On the right: <b>moves / shortest</b> — <b class="lg opt">green = shortest</b> · <b class="lg over">orange = longer</b> · <b class="lg">grey = not there yet</b>',
